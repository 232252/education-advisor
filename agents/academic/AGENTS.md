...
# 端云一体化模块（2026-03-28）
import sys
sys.path.insert(0, '${WORKSPACE_DIR}/scripts')
from cloud_integrated_core_v4 import (
    get_student, sync_score, create_task, 
    send_report, check_status, list_cloud_files,
    search_cloud_files, create_cloud_doc, backup_to_cloud
)

# 端云模块路径
CLOUD_MODULE = '${WORKSPACE_DIR}/scripts/cloud_integrated_core_v4.py'
