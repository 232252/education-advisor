...
export function registerAcademicExamHandlers(): void {
  ...
  handleIpc(IPC.IPC_ACADEMIC_LIST_EXAMS, async (_e: IpcMainInvokeEvent, semester?: string) => {
  ...
  // 删除考试
  handleIpc(IPC.IPC_ACADEMIC_DELETE_EXAM, async (_e: IpcMainInvokeEvent, examId: string) => {
