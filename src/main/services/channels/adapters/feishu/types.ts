// =============================================================
// adapters/feishu/types — 飞书渠道公共类型
// (M3 从 feishu-bot/types.ts 搬入,不变;原文件改为 re-export 壳)
// 通用频道状态类型(ChannelStatusInfo)在 @shared/types/channel;
// BotStatus/BotStatusInfo 为飞书连接层历史状态形状(兼容期保留)。
// =============================================================
