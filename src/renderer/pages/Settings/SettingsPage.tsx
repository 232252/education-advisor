      ...
      <Section title={t('settings.section.feishu')}>
        ...
        >
          <input
            ...
            className={`bg-gray-50 dark:bg-gray-800 border rounded-lg px-2.5 py-1.5 text-xs text-gray-700 dark:text-gray-200 w-48 outline-none transition-colors ${
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  if (result.success) {
                    ...
                    setFeishuTestInfo(
                      `连接成功 · token=${result.token} · 过期 ${result.expireSec}s`,
                    )
                  } else {
                    setFeishuTestStatus('error')
