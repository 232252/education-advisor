...
use crate::ui::widgets::{
    card, danger_button, empty_state, ghost_button, primary_button, search_input, section_title,
    tool_button,
};
...
pub fn show(app: &mut App, ui: &mut Ui) {
    ...
    ui.horizontal(|ui| {
        ...
        ui.with_layout(Layout::right_to_left(Align::Center), |ui| {
            ui.add_space(4.0);
            if tool_button(ui, &app.theme, "导出", icons::download).clicked() {
                app.ui_state.show_export_preview = !app.ui_state.show_export_preview;
            }
            if tool_button(ui, &app.theme, "导入 Excel", icons::upload).clicked() {
            ...
            if tool_button(ui, &app.theme, "导入 CSV", icons::upload).clicked() {
    ...
    ui.horizontal_top(|ui| {
        ...
        ui.vertical(|ui| {
            ...
            let Some(student) = student else {
                card(ui, &app.theme, |ui| {
                    empty_state(ui, &app.theme, icons::students, "选择左侧学生查看档案");
                });
                return;
            };
...
fn detail(app: &mut App, ui: &mut Ui, student: Student) {
    ...
    card(ui, &theme, |ui| {
        ui.horizontal_top(|ui| {
            ...
            ui.with_layout(Layout::right_to_left(Align::TOP), |ui| {
                crate::ui::widgets::badge(
                    ...
                    app.theme.risk_color(student.risk_level),
                );
            });
        });
        ...
        ui.horizontal(|ui| {
            ...
            if ghost_button(ui, &app.theme, "添加标签").clicked()
        ...
        ui.horizontal(|ui| {
            ...
            if tool_button(ui, &app.theme, "咨询代理", icons::chat_color).clicked() {
            ...
            if danger_button(ui, &app.theme, "删除").clicked() {
                let _ = app
                    .runtime
                    .tx
        ...
        .show(ui.ctx(), |ui| {
            ...
            egui::Grid::new("edit_grid")
                ...
                .show(ui, |ui| {
                    ...
                    let mut display = raw
                        .strip_prefix("enc:")
                        .and_then(|rest| app.cipher.decrypt_str(rest).ok())
